...
namespace AutomateToolSwap.InteractionRules
{
    ...
    public class SoilInteractionRules
    {
        ...
        public static bool TrySwap(GameLocation location, Vector2 tile, Farmer player)
        {
            ...
            bool isInFightingLocation = location is Mine ||
            ...
            bool isPriorityToolEquiped = player.CurrentItem is FishingRod ||
                                         player.CurrentItem is GenericTool ||
                                         player.CurrentItem is Wand;
